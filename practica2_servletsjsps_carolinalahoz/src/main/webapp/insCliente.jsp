...
<form class="col-3 card p-1 mt-5" action="http://localhost:8080//practica2_servletsjsps_carolinalahoz/ServletCliente" method="post">
  <div class="mb-3 ">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">NOMBTRE</label>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="saldo">
  </div>
